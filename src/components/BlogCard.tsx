  ...
  return (
    <Link href={`/blog/${post.slug}`} className="group">
      ...
      >
        ...
        <div className="p-6">
          <div className="flex justify-between items-center text-sm text-gray-500 dark:text-gray-400 mb-2 transition-colors duration-500">
            <span>{format(new Date(post.date), 'MMM dd, yyyy')}</span>
            <span>{post.readTime} min read</span>
          </div>
          <h2 className={`text-xl font-semibold mb-3 transition-all duration-1000 ease-in-out ${
          ...
          <div className="relative overflow-hidden">
            <p
              className={`text-gray-600 dark:text-gray-300 overflow-hidden leading-normal transition-[max-height,opacity] duration-500 ease-in-out ${
